    ...
    >
      <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
          <img class="w-12 h-12" src="@/assets/logo.svg" alt="Logo of MisEscapes" />

          <span class="mx-2 text-2xl font-semibold text-pink-700">MisJuegos</span>
        </div>
      </div>
      ...
      <nav class="mt-10">
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Input' ? activeClass : inactiveClass]"
          to="/input"
        >
          ...
          <span class="mx-4">Add a game</span>
        </router-link>
