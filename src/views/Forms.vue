          ...
          <form>
            ...
            <div class="px-5 py-6 text-gray-700 bg-gray-200 border-b">
              ...
              <div class="relative mt-2 rounded-md shadow-sm">
                ...
                <input
                  type="text"
                  class="w-full px-12 py-2 border-transparent rounded-md appearance-none focus:border-pink-600 focus:ring focus:ring-opacity-40 focus:ring-pink-500"
                />
              </div>
            </div>
            ...
            <div class="flex items-center justify-between px-5 py-3">
              ...
              <button
                class="px-3 py-1 text-sm text-white bg-pink-600 rounded-md hover:bg-pink-500 focus:outline-none"
              >
                Save
              </button>
            </div>
          ...
          <form @submit.prevent="register">
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  class="w-full mt-2 border-gray-200 rounded-md focus:border-pink-600 focus:ring focus:ring-opacity-40 focus:ring-pink-500"
                  type="text"
